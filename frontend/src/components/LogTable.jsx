...
const LogTable = ({ onReplay = null }) => {
  ...
  const getProviderColor = (provider) => {
    const colors = {
      ...
      "ollama-cloud": "bg-sky-100 text-sky-800 border-sky-200",
      openrouter: "bg-purple-100 text-purple-800 border-purple-200",
      mistral: "bg-orange-100 text-orange-800 border-orange-200",
      gemini: "bg-red-100 text-red-800 border-red-200",
      grok: "bg-indigo-100 text-indigo-800 border-indigo-200",
    };
    return (
