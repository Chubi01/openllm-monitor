...
class CostEstimator {
  constructor() {
    ...
    this.pricing = {
      ...
      // Ollama Cloud — GPU-time based, no per-token pricing
      // Pro $20/mo: 3 concurrent | Max $100/mo: 10 concurrent
      // Cost shown as $0 since it's subscription-based, not per-token
      "ollama-cloud": {
        default: {
          prompt: 0.0,
          completion: 0.0,
